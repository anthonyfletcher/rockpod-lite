 ...
 *
 * Orderly shutdown and system events: flushing state to disk, the poweroff
 * path, the default event handler, and the car-adapter and
 * headphone-unplug behaviours.
 ****************************************************************************/
