 ...
 * was: apps/recorder/bmp.c
 * Copyright (C) 2002 by Linus Nielsen Feltzing
 * GNU General Public License (version 2+)
 *
 * Reads Windows BMP files into a rockbox bitmap. Handles 1/4/8/16/24-bit
 * input, RLE, palettes and dithering, and can scale on load via resize.c.
 ****************************************************************************/
