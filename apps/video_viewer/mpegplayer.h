...
/* Core headers -- this internal umbrella replaces the plugin.h the viewer used
 * as a plugin; the individual translation units include it in that role. */
#include <string.h>
...
/* Must follow config.h (above) to override the IRAM section attributes. */
#include "mpeg_no_iram.h"
