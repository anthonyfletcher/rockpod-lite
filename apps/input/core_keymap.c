 ...
 * was: apps/core_keymap.c
 * Copyright (C) 2020 by William Wilgus
 * GNU General Public License (version 2+)
 *
 * Loads a user keymap file (.kmf) from disk and overrides the built-in
 * mapping. The header ID embeds the action count so a stale file is
