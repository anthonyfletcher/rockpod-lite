...
#undef EQ_BAND
    ...
    TEXT_SETTING(0, text_viewer_font_file, "text viewer font", "",
                 FONT_DIR "/", ".fnt"),
    CHOICE_SETTING(0, text_viewer_page_location, LANG_TEXT_VIEWER_PAGE_LOCATION,
                   0, "text viewer page location", "off,page,file", NULL, 3,
                   ID2P(LANG_OFF),
                   ID2P(LANG_TEXT_VIEWER_PAGE_NUMBER),
                   ID2P(LANG_TEXT_VIEWER_FILE_LOCATION)),
