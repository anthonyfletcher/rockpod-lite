 ...
 * was: apps/image_viewer/decoders/jpeg_decoder.c
 * JPEG image viewer
 ...
 *
 * Baseline JPEG decoding for the viewer: Huffman, dequantisation and IDCT
 * into a native bitmap.
 ****************************************************************************/

#include "config.h"
#include <string.h>
#include "system.h"     /* BIT_N */
