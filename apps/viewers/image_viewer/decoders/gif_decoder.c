 ...
 * was: apps/image_viewer/decoders/gif_decoder.c
 * Copyright (c) 2012 Marcin Bukat
 * GNU General Public License (version 2+)
 *
 * GIF decoding on top of vendored giflib: drives the frame loop and
 * converts palette output to native pixels.
 ****************************************************************************/

#include <string.h>
#include "lcd.h"
#include "draw/resize.h"     /* format_native, scaler_context, recalc_dimension */
#include "draw/bmp.h"        /* struct uint8_rgb, struct bitmap */
