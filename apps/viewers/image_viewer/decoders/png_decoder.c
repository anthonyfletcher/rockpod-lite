 ...
 * was: apps/image_viewer/decoders/png_decoder.c
 ...
 *
 * PNG parser: chunk walking, filter reversal and interlace handling,
 * inflating through tinflate.c.
 ****************************************************************************/
...
#include <string.h>
#include "lcd.h"
#include "draw/resize.h"     /* recalc_dimension, struct dim (aspect correction) */
#include "tinf.h"
#include "draw/bmp.h"
